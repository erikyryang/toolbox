...
import { languageBootScript } from "@/lib/i18n";
...
export const metadata: Metadata = {
  title: {
    default: "toolbox — data and file utilities, in your browser",
    template: "%s — toolbox",
  },
  description:
    "Encoding, conversion, and compression for data and files. No accounts, history, or stored files.",

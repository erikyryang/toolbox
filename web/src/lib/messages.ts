...
export const en = {
  ...
  "ui.extractRouting": "ZIP, GZIP, and TAR run locally up to {limit}. ZSTD, RAR, and 7Z use the server.",
  "ui.level": "level",
  "ui.of": "of",
  "ui.preset.fast": "Fast",
...
export const pt: Record<MessageKey, string> = {
  ...
  "ui.extractRouting": "ZIP, GZIP e TAR rodam localmente até {limit}. ZSTD, RAR e 7Z usam o servidor.",
  "ui.level": "nível",
  "ui.of": "de",

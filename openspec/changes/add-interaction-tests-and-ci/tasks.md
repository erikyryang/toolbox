...
- [x] 1.4 Documentar comandos, portas, fixtures e variáveis exclusivas de teste.
- [x] 1.5 Executar testes locais, lint, typecheck, build, go test e validação OpenSpec.
...
- Ambiente local: macOS arm64, Node 26.7.0 e Go 1.27.1; `go.mod` declara Go 1.25.1.

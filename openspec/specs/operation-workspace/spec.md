...
## Purpose
A tela comum a toda operação: rota dedicada, dois painéis com inversão de sentido, conversão em tempo real, opções atrás de disclosure, erros inline e o indicador fiel de onde o processamento aconteceu.

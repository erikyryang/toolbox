# zero-persistence Specification

## Purpose
A garantia de que nenhum conteúdo de quem usa é gravado, cacheado, registrado em log ou entregue a terceiros, em nenhum ponto do sistema.

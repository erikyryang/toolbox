# data-size-conversion Specification

## Purpose
Conversão local de valores entre bit, byte, KB, MB, GB e TB, com base decimal ou binária explícita, entrada numérica, sentido invertível e nota da convenção aplicada.

...
## Purpose
A linguagem visual do produto: paleta em tons quentes, acento reservado a ações primárias, tokens semânticos como única interface de cor, tipografia, contraste AA nos dois temas e a preferência de tema.
